...
export default async function MyInfoPage() {
  ...
  return (
    <div className="flex flex-col p-4 h-[calc(100dvh-9rem)]">
      ...
      <div className="w-full border border-gray-200 p-5 rounded-2xl flex flex-col gap-4 mb-6">
      ...
      <div className="w-full border border-gray-200 p-5 rounded-2xl flex flex-col gap-4">
        ...
        <div className="w-full border border-gray-200 p-4 rounded-2xl grid grid-cols-5 gap-3 place-items-center">
